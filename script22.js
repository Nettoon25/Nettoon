...
const cancelSigninBtn = document.querySelector('.signin-cancel-btn');

/* ===================================================== */
/* AUTH TRIGGERS */
/* Anything in this list will open the sign-in popup */
/* ===================================================== */
...
const authTriggers = [
  ...
  /* Main option popup actions */
  '.option-popup .popup-item',

  /* Other popup menu actions */
  '.popup-options .popup-item',

  /* Optional direct classes */
    /*'.auth-share',*/
  '.auth-playlist',
  '.auth-report'
];
...
authTriggers.forEach(selector => {
  document.querySelectorAll(selector).forEach(item => {
    item.addEventListener('click', (e) => {
      e.preventDefault();
      e.stopPropagation(); // prevents popup close conflicts
